 ...
 *            than the size of the stack before the call.
 *          . Top will find the Item that was inserted.
 *********************************************************************/
...
/*********************************************************************
 * FUNCTION NAME: Top
 * PURPOSE: Grabs the top of the stack.
 * ARGUMENTS: . The address of the Stack (Stack *S)
 *            . The address of the Item
 *              the Item taken should be copied to
 * REQUIRES: . The Stack should not be empty.
 *********************************************************************/
