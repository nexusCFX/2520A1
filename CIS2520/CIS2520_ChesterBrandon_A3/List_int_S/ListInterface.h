...
/*********************************************************************
 * FUNCTION NAME: Merge
 * PURPOSE: Merges together the split lists used during MergeSort
 * ARGUMENTS: The address of the List (List *)
              The first index of the list array
              The middle index of the list array
 ...
 * PURPOSE: Breaks a list into smaller lists and sorts them
 * ARGUMENTS: The address of the List (List *)
              The first index of the list array
              The last index of the list array
 *********************************************************************/
 ...
 * PURPOSE: Iterates over a list and sorts it using Bubble Sort
 * ARGUMENTS: The address of the List (List *)
 *********************************************************************/
